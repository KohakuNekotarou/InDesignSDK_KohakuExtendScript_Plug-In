...
DECLARE_PMID(kClassIDSpace, kKESShortcutScriptProviderBoss, kKESPrefix + 1)
...
DECLARE_PMID(kImplementationIDSpace, kKESShortcutScriptImpl, kKESPrefix + 3)
DECLARE_PMID(kImplementationIDSpace, kKESShortcutScriptProviderImpl, kKESPrefix + 4)
